...
//     + fib(n - 2) otherwise.
//     factorial accepts a single integer n and returns 1 if n <= 1 
//     or factorial(n - 1) * n otherwise.
...
// memoizedSum(2, 2); // "call" - returns 4. sum() was called as (2, 2)
//  was not seen before.
// memoizedSum(2, 2); // "call" - returns 4. However sum() was not called 
// because the same inputs were seen before.
// // "getCallCount" - total call count: 1
// memoizedSum(1, 2); // "call" - returns 3. sum() was called as (1, 2) 
// was not seen before.
